...
const research = require("./family1.research.json");
...
function classifyFamily1(assertedConditionText) {
...
function matchesFamily1(assertedConditionText) {
  return classifyFamily1(assertedConditionText).matched;
}
