...
function runFixture(fixture) {
  ...
  const expectedNote = fixture.expected_matter_level_note || "";
  assert.equal(determinationRecord.matter_level_note, expectedNote);
...
test("D.4 mobile-only eligible fixture passes end-to-end", () => {
  runFixture(loadFixture("d4_mobile_only_eligible.json"));
});

test("D.5 mobile eligible desktop constrained fixture passes end-to-end", () => {
  runFixture(loadFixture("d5_mobile_eligible_desktop_constrained.json"));
});